...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
			...
			{ "U_I_CombatUniform", SEK Uniform, 25, "call life_coplevel >= 5" }
        };
        headgear[] = {
            { "NONE", $STR_C_Remove_headgear, 0, "" },
            { "H_Cap_police", "", 25, "" },
    ...
    class med_clothing {
        ...
        uniforms[] = {
            { "NONE", $STR_C_Remove_uniforms, 0, "" },
            { "U_Rangemaster", Dienstkleidung, 50, "" }, //U_BG_Guerilla2_1
        };
        headgear[] = {
            { "NONE", $STR_C_Remove_headgear, 0, "" },
            { "H_Beret_blk", "", 10, "call life_mediclevel >= 4" }
        };
        goggles[] = {
            { "NONE", $STR_C_Remove_goggles, 0, "" },
        ...
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_Carryall_cbr", $STR_C_EMS_backpacks, 100, "" },
			{ "B_Bergen_tna_F", "", 500, "" }
        };
    };
