...
compileFinal "
    ...
    switch (_type) do {
        ...
        case 1 : {
            ...
            _message = format [""--- 911 NOTRUF VON %1: %2"",_from,_msg];
            if (isNil ""_loc"") then {_loc = ""Unknown"";};
            hint parseText format [""<t color='#316dff'><t size='2'><t align='center'>Neuer Notruf<br/><br/><t color='#33CC33'><t align='left'><t size='1'>Ab: <t color='#ffffff'>Alle Polizeibeamten<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><t color='#33CC33'>Koordinaten: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%3"",_from,_loc,_msg];
        ...
        case 2 : {
            ...
            if (isNil ""_loc"") then {_loc = ""Unknown"";};
            hint parseText format [""<t color='#ffcefe'><t size='2'><t align='center'>Admin Nachricht<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Administratoren<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><t color='#33CC33'>Koordinaten: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%3"",_from,_loc,_msg];
        ...
        case 4 : {
            ...
            _admin = format [""Sent by admin: %1"", _from];
            hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Admin Message<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Spieler<br/><t color='#33CC33'>Von: <t color='#ffffff'>den Admins<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];

            [""AdminMessage"",[""Du hast eine Admin Nachricht bekommen!""]] call bis_fnc_showNotification;
            systemChat _message;
            if ((call life_adminlevel) > 0) then {systemChat _admin;};
        };
        ...
        case 5: {
            ...
            _loc = _this select 3;
            _unit = _this select 4;
            _message = format [""!!! RETTUNGSDIENST NOTRUF: %1"",_msg];
            hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>Rettungsdienst angefordert<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Beamten des Rettungsdienst<br/><t color='#33CC33'>Von: <t color='#ffffff'>%1<br/><t color='#33CC33'>Koordinaten: <t color='#ffffff'>%2<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%3"",_from,_loc,_msg];

            [""TextMessage"",[format [""Rettungsdienst Notruf von %1"",_from]]] call bis_fnc_showNotification;
        };
    };
";
