...
/* System Settings */
    ...
    news_broadcast_header_length = 600; //Number of characters that a header can consist of. Anything over this may clip. This depends on the font size and various other factors. Adjust with caution.
    ...
    house_limit = 10; //Maximum number of houses a player can own.
    houseGarage_buyPrice = 10000000;
    houseGarage_sellPrice = 3500000;
